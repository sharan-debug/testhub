...
QA_UTILITY_URL = os.environ.get('QA_UTILITY_URL', '').rstrip('/')
QA_UTILITY_USERNAME = os.environ.get('QA_UTILITY_USERNAME', '')
QA_UTILITY_PASSWORD = os.environ.get('QA_UTILITY_PASSWORD', '')
